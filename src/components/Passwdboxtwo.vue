...
export default {
 ...
 data () {
  ...
  props: {
    id: 2, // 当一个页面有多个密码输入框时，用id来区分
    // default: '1'
  },
  mounted () {　　
    this.ipt = document.querySelectorAll(`#ids_${this.id} .shortInput2`)
  },
  methods: {
    keyUp (ev) {
...
.am_payPwd .shortInput2:focus{
    border:none;
}
.am_payPwd .shortInput2:not(:last-child) {
