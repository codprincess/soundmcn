...
export default {
 ...
 data () {
  ...
  props: {
    id: 3, // 当一个页面有多个密码输入框时，用id来区分
    // default: '1'
  },
  mounted () {　　
    this.ipt = document.querySelectorAll(`#ids_${this.id} .shortInput3`)
  },
  methods: {
    keyUp (ev) {
...
.am_payPwd .shortInput3:focus{
    border:none;
}
.am_payPwd .shortInput3:not(:last-child) {
